    ...
    <div class="span6 form-box">
        <div class="row-fluid">
            <div class="span6" style="height:100%;">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <img src="<?php echo base_url();?>assets/images/lms2.png">
                    </div>
                </div>
            </div>
            <div class="span6">
                ...
                <input class="input-medium" type="password" name="password" id="password" value="<?php echo (ENVIRONMENT=='demo')?'bbalet':''; ?>" /><br /><br />
