    ...
    <div class="row" id="footer">
        ...
        <div class="span4 pull-right">
              <?php switch ($language_code){
                  case 'fr' : echo '<a class="anchor" href="https://fr.jorani.org/" target="_blank">LMS</a>'; break;
                  default : echo '<a class="anchor" href="https://jorani.org/" target="_blank">LMS</a>'; break;
              } ?>
          &nbsp;v<?php echo $GLOBALS['versionOfJorani'];?>&nbsp;&copy;2014-2019 LMS
        </div>
    </div>
    </div>
